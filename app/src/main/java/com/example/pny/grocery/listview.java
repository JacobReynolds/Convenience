...
public class listview extends ActionBarActivity {
    ...
    public void addDisplayItem (LinearLayout view, final String hash, final String nickname) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                displayListOptions(hash);
            }
        });
        view.addView(button);
    }

    private void displayListOptions(final String hash) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which) {
                            ...
                            case 1:
                                ...
                                final Intent intent = new Intent(listview.this, MainActivity.class);
                                startActivity(intent);
                                break;
                            case 2:
                                removeListFromUser(hash);
                                break;
                        }
                    }
                });
    ...
    private void removeListFromUser(String list) {
    ...
    public void createDatabaseText() {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder1 = new AlertDialog.Builder(listview.this);
                final EditText input = new EditText(listview.this);
// Specify the type of input expected; this, for example, sets the input as a password, and will mask the text
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder1 = new AlertDialog.Builder(listview.this);
                // Specify the type of input expected; this, for example, sets the input as a password, and will mask the text
                LinearLayout layout = new LinearLayout(listview.this);
                layout.setOrientation(LinearLayout.VERTICAL);

                final EditText hashBox = new EditText(listview.this);
                hashBox.setHint("List hash");
                layout.addView(hashBox);

                final EditText nicknameBox = new EditText(listview.this);
